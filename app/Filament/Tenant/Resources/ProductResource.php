...
class ProductResource extends Resource
{
    ...
    {
        return can('lihat produk');
    }

    public static function canCreate(): bool
    {
        return can('buat produk');
    }

    public static function canEdit($record): bool
    {
        return can('ubah produk');
    }

    public static function canDelete($record): bool
    {
        return can('hapus produk');
    }
    ...
    // ✅ INI YANG DIPERBAIKI - Infolist untuk halaman View
    public static function infolist(Infolist $infolist): Infolist
    {
        return $infolist->schema([
            Infolists\Components\ImageEntry::make('hero_image')  // ✅ GANTI JADI SINGULAR
                ->label(__('Hero Image'))
