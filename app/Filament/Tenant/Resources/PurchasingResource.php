...
use App\Filament\Tenant\Resources\PurchasingResource\RelationManagers;
...
class PurchasingResource extends Resource
{
    ...
    {
        return can('lihat pembelian');
    }

    public static function canCreate(): bool
    {
        return can('buat pembelian');
    }

    public static function canEdit($record): bool
    {
        return can('ubah pembelian');
    }

    public static function canDelete($record): bool
    {
        return can('hapus pembelian');
    }
