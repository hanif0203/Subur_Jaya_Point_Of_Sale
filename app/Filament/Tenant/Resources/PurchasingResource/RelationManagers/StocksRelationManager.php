...
class StocksRelationManager extends RelationManager
{
    ...
    /**
     * ⭐ PERBAIKAN 1: Tambahkan permission check untuk view relation ⭐
     * Method ini mengatur siapa yang bisa melihat tab "Stocks" di halaman purchasing
     * Role gudang, admin, atau siapa saja yang punya permission bisa akses
     */
    public static function canViewForRecord($ownerRecord, string $pageClass): bool
    {
        return can('lihat pembelian') || can('ubah pembelian') || can('buat pembelian');
    }
        ...
        return $table
            ...
            ->headerActions([
                Tables\Actions\CreateAction::make()
                    ->label(__('Add Item'))
                    /**
                     * ⭐ PERBAIKAN 2: Tambahkan permission check untuk tombol "Add Item" ⭐
                     * Tombol "Add Item" hanya muncul jika:
                     * 1. User punya permission 'buat pembelian' ATAU 'ubah pembelian'
                     * 2. DAN purchasing belum di-approve (isReadOnly = false)
                     * 
                     * Ini yang membuat role gudang bisa melihat dan menggunakan tombol Add Item
                     */
                    ->visible(fn () => (can('buat pembelian') || can('ubah pembelian')) && !$this->isReadOnly())
            ...
            ->actions([
                Tables\Actions\DeleteAction::make()
                    ...
                    /**
                     * ⭐ PERBAIKAN 3: Tambahkan permission check untuk delete action ⭐
                     * Tombol delete hanya muncul jika:
                     * 1. User punya permission 'hapus pembelian'
                     * 2. DAN purchasing belum di-approve
                     * 
                     * Jika role gudang tidak boleh hapus, permission 'hapus pembelian' 
                     * tidak perlu diberikan ke role gudang
                     */
                    ->visible(fn () => can('hapus pembelian') && $this->ownerRecord->status != PurchasingStatus::approved)
