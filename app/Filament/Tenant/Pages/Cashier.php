...
class Cashier extends Page implements HasForms, HasTable
{
    ...
    public function updatedCartDetailPayedMoney($value)
    {
        // Bersihkan dari format
        $cleanValue = preg_replace('/[^\d.]/', '', $value);
        
        // Convert to float
        $this->cartDetail['payed_money'] = floatval($cleanValue);
        
        // Hitung kembalian
        $this->cartDetail['money_changes'] = $this->cartDetail['payed_money'] - $this->total_price;
    }
}